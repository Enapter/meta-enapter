...
disk_kernel_1_label="enp-kernel-a"
disk_kernel_2_label="enp-kernel-b"
disk_root_1_label="enp-root-a"
disk_root_2_label="enp-root-b"
disk_app_1_label="enp-app-a"
disk_app_2_label="enp-app-b"
