...
legacy_hdd_boot_device="/dev/disk/by-label/$disk_legacy_boot_label"
legacy_hdd_data_device="/dev/disk/by-label/$disk_legacy_data_label"
legacy_hdd_data_reset_device="/dev/disk/by-label/$disk_legacy_data_reset_label"
